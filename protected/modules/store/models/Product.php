...
class Product extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            [
                'name, title, description, short_description, slug, price, discount_price, discount, data, status, cost, is_special',
                'filter',
                'filter' => 'trim',
            ],
            [
                'name, title, description, short_description, slug, price, discount_price, discount, data, status, is_special, cost',
                'filter',
            ...
            [
                'price, average_price, purchase_price, recommended_price, discount_price, discount, length, height, width, weight, cost',
            ...
            ['discount_price, discount, average_price, purchase_price, recommended_price, cost', 'default', 'value' => null],
            ...
            ['meta_canonical', 'url'],
            [
                'id, type_id, producer_id, sku, name, slug, price, discount_price, discount, short_description, description, data, is_special, length, height, width, weight, quantity, in_stock, status, create_time, update_time, meta_title, meta_description, meta_keywords, category_id, cost',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cost' => Yii::t('StoreModule.store', 'Стоимость заказа'),
        ];
    }
